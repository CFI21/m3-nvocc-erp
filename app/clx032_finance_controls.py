...
router=APIRouter(prefix='/api/clx032', tags=['CLX-032 Finance Approval + Delegation + SoD'])
...
def workspace(
    ...
    return {'phase':'CLX-032','approval_limits':limits,'delegations':delegations,'sod_conflicts':sod,'access_reviews':reviews,'audit':audit_rows}
