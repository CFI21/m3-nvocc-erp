...
ADMIN_TABLE={
 ...
 'data-scope-rules':'iam_scope_rules','customer-agent-access':'iam_party_access','approval-limits':'iam_approval_limits','maker-checker':'iam_sod_conflicts','approval-delegations':'iam_delegations','temporary-access':'iam_temporary_access','access-reviews':'iam_access_reviews','sessions':'iam_sessions','login-audit':'iam_login_audit','service-accounts':'iam_service_accounts','api-clients':'iam_api_clients','identity-audit':'iam_audit_events',
